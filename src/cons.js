...
if(true){// testnet comand
    ...
    SCtest = "0xc667dbe8B57dE70663a673C9A6069BBd53259dd1";// direccion del contrato de pruebas test only no real
    SC = "0xc667dbe8B57dE70663a673C9A6069BBd53259dd1";// direccion del contrato V1
    SC2 = "0xc667dbe8B57dE70663a673C9A6069BBd53259dd1";// direccion del contrato V2
